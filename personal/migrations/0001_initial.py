...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rank'
        db.create_table('personal_rank', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('abrev', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('personal', ['Rank'])

        # Adding model 'Firefighter'
        db.create_table('personal_firefighter', (
            ...
            ('blood_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('blood_type_rh', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('initials', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('number', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('personal', ['Firefighter'])

        # Adding model 'RankChange'
        db.create_table('personal_rankchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firefighter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Firefighter'])),
            ('rank_obtained', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Rank'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('personal', ['RankChange'])

        # Adding model 'Condition'
        db.create_table('personal_condition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('personal', ['Condition'])

        # Adding model 'ConditionChange'
        db.create_table('personal_conditionchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firefighter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Firefighter'])),
            ('condition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Condition'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('personal', ['ConditionChange'])

        # Adding model 'Condecoration'
        db.create_table('personal_condecoration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('personal', ['Condecoration'])

        # Adding model 'CondecorationAward'
        db.create_table('personal_condecorationaward', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firefighter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Firefighter'])),
            ('condecoration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Condecoration'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('personal', ['CondecorationAward'])

        # Adding model 'FirefighterHoliday'
        db.create_table('personal_firefighterholiday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firefighter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Firefighter'])),
            ('start_at', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('end_at', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ))
        db.send_create_signal('personal', ['FirefighterHoliday'])

        # Adding unique constraint on 'FirefighterHoliday', fields ['firefighter', 'start_at', 'end_at']
        db.create_unique('personal_firefighterholiday', ['firefighter_id', 'start_at', 'end_at'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FirefighterHoliday', fields ['firefighter', 'start_at', 'end_at']
        db.delete_unique('personal_firefighterholiday', ['firefighter_id', 'start_at', 'end_at'])

        # Deleting model 'Rank'
        db.delete_table('personal_rank')

        # Deleting model 'Firefighter'
        db.delete_table('personal_firefighter')

        # Deleting model 'RankChange'
        db.delete_table('personal_rankchange')

        # Deleting model 'Condition'
        db.delete_table('personal_condition')

        # Deleting model 'ConditionChange'
        db.delete_table('personal_conditionchange')

        # Deleting model 'Condecoration'
        db.delete_table('personal_condecoration')

        # Deleting model 'CondecorationAward'
        db.delete_table('personal_condecorationaward')

        # Deleting model 'FirefighterHoliday'
        db.delete_table('personal_firefighterholiday')
