...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ops_vehicle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('ops', ['Vehicle'])

        # Adding model 'Service'
        db.create_table('ops_service', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='services_created', to=orm['personal.Firefighter'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('time', self.gf('django.db.models.fields.TimeField')()),
            ('service_type', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('location', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('map_location', self.gf('common.widgets.LocationField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('ops', ['Service'])
        ...
        # Adding model 'ServiceVehicle'
        db.create_table('ops_servicevehicle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vehicles', to=orm['ops.Service'])),
            ('lead', self.gf('django.db.models.fields.related.ForeignKey')(related_name='services_lead', to=orm['personal.Firefighter'])),
            ('driver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='services_drove', to=orm['personal.Firefighter'])),
            ('vehicle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ops.Vehicle'])),
        ))
        db.send_create_signal('ops', ['ServiceVehicle'])

        # Adding M2M table for field crew on 'ServiceVehicle'
        db.create_table('ops_servicevehicle_crew', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('servicevehicle', models.ForeignKey(orm['ops.servicevehicle'], null=False)),
            ('firefighter', models.ForeignKey(orm['personal.firefighter'], null=False))
        ))
        db.create_unique('ops_servicevehicle_crew', ['servicevehicle_id', 'firefighter_id'])


    def backwards(self, orm):

        # Deleting model 'Vehicle'
        db.delete_table('ops_vehicle')

        # Deleting model 'Service'
        db.delete_table('ops_service')

        # Removing M2M table for field patients on 'Service'
        db.delete_table('ops_service_patients')

        # Deleting model 'ServiceVehicle'
        db.delete_table('ops_servicevehicle')

        # Removing M2M table for field crew on 'ServiceVehicle'
        db.delete_table('ops_servicevehicle_crew')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 0, 16, 26, 982534)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 0, 16, 26, 982454)'}),
        ...
        'ops.service': {
            ...
            'patients': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.BasePerson']", 'symmetrical': 'False'}),
