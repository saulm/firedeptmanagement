...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ops_service', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['personal.Firefighter']))


    def backwards(self, orm):
        
        # Changing field 'Service.created_by'
        db.alter_column('ops_service', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=' ', to=orm['personal.Firefighter']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 23, 10, 21, 185185)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 23, 10, 21, 184904)'}),
        ...
        'ops.service': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'services_created'", 'null': 'True', 'to': "orm['personal.Firefighter']"}),
