...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.scene_arrival_date'
        db.add_column(u'ops_service', 'scene_arrival_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Service.scene_arrival_time'
        db.add_column(u'ops_service', 'scene_arrival_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Service.end_date'
        db.add_column(u'ops_service', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Service.end_time'
        db.add_column(u'ops_service', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.scene_arrival_date'
        db.delete_column(u'ops_service', 'scene_arrival_date')

        # Deleting field 'Service.scene_arrival_time'
        db.delete_column(u'ops_service', 'scene_arrival_time')

        # Deleting field 'Service.end_date'
        db.delete_column(u'ops_service', 'end_date')

        # Deleting field 'Service.end_time'
        db.delete_column(u'ops_service', 'end_time')
