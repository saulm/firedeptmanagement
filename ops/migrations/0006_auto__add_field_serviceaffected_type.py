...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServiceAffected.type'
        db.add_column('ops_serviceaffected', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServiceAffected.type'
        db.delete_column('ops_serviceaffected', 'type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 15, 23, 58, 134396)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 15, 23, 58, 134312)'}),
