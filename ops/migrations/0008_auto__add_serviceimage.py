...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceImage'
        db.create_table(u'ops_serviceimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['ops.Service'])),
            ('uploader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['personal.Firefighter'])),
            ('file', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'ops', ['ServiceImage'])


    def backwards(self, orm):
        # Deleting model 'ServiceImage'
        db.delete_table(u'ops_serviceimage')
    ...
    models = {
        ...
        u'personal.firefighter': {
            ...
            'file': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
